...
void setup() {
  ...
  //pulseSensor.analogInput(sensorPinHeart);   
  //pulseSensor.setThreshold(sensorThresholdHeart);   
...
void loop() {
  ...
  //sensorValueGlucose = analogRead(sensorPinGlucose);
  //sensorValueHeart = analogRead(sensorPinHeart);
  //Serial.print("Glucose: ");
  //Serial.println(sensorValueGlucose);
  //Serial.print("Heart: ");
 ...
 // } 
  //sensorValueHeart = pulseSensor.getBeatsPerMinute();  // Calls function on our pulseSensor object that returns BPM as an "int".
  //if (pulseSensor.sawStartOfBeat()) {            // Constantly test to see if "a beat happened". 
  // Serial.print("BPM: ");                        // Print phrase "BPM: " 
  // Serial.println(sensorValueHeart);                        // Print the value inside of myBPM. 
