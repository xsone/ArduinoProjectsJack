...
byte sendEmail()
{
  ...
  if(client.connect("smtp.ziggo.nl",25)) {    
    Serial.println(F("connected"));
  } else {
  ...
  client.fastrprintln(F("HELLO 212.127.237.142"));
...
// change to your address
  ...
  client.fastrprintln(F("Subject: Panic Alarm!\r\n"));

  client.fastrprintln(F("The panic button was pressed!!!"));
