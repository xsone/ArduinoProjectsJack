...
//IPAddress timeServer(62, 112, 195, 56); // time-c.timefreq.bldrdoc.gov NTP server werkt!
//IPAddress timeServer(131, 211, 8, 244); // pool.ntp.org NTP server in Ziggo router werkt soms! Onbetrouwbaar
//IPAddress timeServer(129, 6, 15, 28); // time.nist.gov NTP server werkt goed maar USA
IPAddress timeServer(194, 109, 22, 18); //ntp.xs4all.nl 
