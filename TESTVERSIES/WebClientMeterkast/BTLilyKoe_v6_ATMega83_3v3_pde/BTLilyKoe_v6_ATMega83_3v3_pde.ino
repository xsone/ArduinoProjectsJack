...
//}
 ...
 while(mySerial.read() != "PAIRABLE")
  {
   Serial.println("AT+STATE?"); delay(500);
   mySerial.println("AT+STATE?"); delay(500);
 
    
    
    Serial.println("AT+INQ"); delay(500);
   mySerial.println("AT+INQ"); delay(10000);
   if((char) mySerial.read() == 'K') state = 1;
  } 
...
void Message()
{
 ...
 hc05.print((int)angle_x);
 //Serial.print("\t");
 //Serial.print(angle_x_old);
 hc05.print(":");
 hc05.print((int)angle_y);
 //Serial.print("\t");
 //Serial.print(angle_y_old);
 hc05.print(":");
 hc05.println((int)angle_z);
