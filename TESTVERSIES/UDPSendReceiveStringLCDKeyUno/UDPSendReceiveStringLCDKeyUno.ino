...
#define DHTPIN 2     // what pin we're connected to op UNO
...
byte mac[] = { 0xDF, 0xAD, 0xBE, 0x00, 0x8E, 0x13 };
...
void setup() 
{
  ...
  server.begin();
  Udp.begin(localPort);
  //attachInterrupt(0, ZonRead, FALLING);   //interrupt 2 digital pin 3 UNO-board
