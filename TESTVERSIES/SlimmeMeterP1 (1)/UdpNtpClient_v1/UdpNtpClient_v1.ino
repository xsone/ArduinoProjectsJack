...
time_t syncInterval = 5UL;         // ntp sync every syncinterval seconds  
...
void ntpTimeSync() {  
  ...
  if ( Udp.parsePacket() ) {  
    ...
    //Serial.println((epoch  % 86400L) / 3600); // print the hour (86400 equals secs per day) + 2 hrs time diff.
