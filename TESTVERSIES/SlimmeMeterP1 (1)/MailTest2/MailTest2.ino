...
byte sendEmail()
{
  ...
  if(client.connect("smtp.gmail.com",587) == 1) {
...
// change to your email address (sender)
  client.println(F("MAIL From: <xsone2@gmail.com>"));
 
  if(!eRcv()) return 0;
 
// change to recipient address
  Serial.println(F("Sending To"));
  client.println(F("RCPT To: <xsone2@gmail.com>"));
...
// change to recipient address
  client.println(F("To: You <xsone2@gmail.com>"));
 
// change to your address
  client.println(F("From: Me <xsone2@gmail.com>"));
