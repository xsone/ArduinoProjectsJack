...
const int CVled = 3; // andere pinnen geven problemen met LCD + ethershield
//const int pirLedPin = 12;
const int potPin = A3;  // select the analog input pin for the potentiometer
...
void loop()
{
 ...
 SetPoint = potVal/35; //bereik Potmater 0-1024, bereik Setpoint 0-30 C dus delen door 35
