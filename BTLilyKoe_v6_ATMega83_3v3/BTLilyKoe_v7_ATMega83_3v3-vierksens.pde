...
#define ref_x 300 // 400 bij ronde ADXL; 300 bij vierkante ADXL; referentiewaarde Y-as is alleen relevant voor staartmeting: zero_y=0°; up_y=90°; down_y=270°
#define ref_y 300 // referentiewaarde Y-as is alleen relevant voor staartmeting: zero_y=0°; up_y=90°; down_y=270°
#define ref_z 300 // referentiewaarde Y-as is alleen relevant voor staartmeting: zero_y=0°; up_y=90°; down_y=270°
...
void PhoneInit()
{
 //char BTadress[20];
  ...
  //hc05.getState("HC05_PAIRED",1000);
...
//}
 ...
 mySerial.println("AT+INQ"); delay(10000);
 ...
 while(!state)
  {
   Serial.println("AT+INQ"); delay(500);
   mySerial.println("AT+INQ"); delay(2000);
   if((char) mySerial.read() == 'K') 
    {
     state = 1;
     break;
    } 
...
void loop() 
{
 ...
 Message();
 delay(5000);   //iedere 10sec. waarde doorgeven
}
