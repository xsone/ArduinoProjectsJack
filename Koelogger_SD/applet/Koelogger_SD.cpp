...
while(digitalRead(4)!=HIGH)
  {
    ...
    if(digitalRead(2)==HIGH&&hoog==0) {  //sensorinput 2
      tel++;
      if (tel>5){
        ...
        delay(300);  
        Serial.println("AT+CMGS=18\r\n"); 
        delay(300);
        Serial.println("07911326060032F011000B911346992871F60004AA044B616C66"); 
        delay(300);
   ...
   if(digitalRead(2)==LOW) hoog=0; //sensorinput 2  
} //einde setup
file.close();
